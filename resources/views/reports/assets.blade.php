...
@section('title', 'Asset Report - PNOC')
@section('customcss')
   ...
   <div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-lg-12 stretch-card">
            <div class="card">
               <div class="card-header">Asset Report</div>
                    ...
                    <div id="search-form_container">
                        ...
                        <div class="col-lg-12 text-right">
                           ...
                           Export to PDF <i class="mdi mdi mdi-file-pdf btn-icon-append"></i>
                                ...
                                <a style="position: relative; z-index: 999;" href="javascript:void(0);" class="btn btn-primary btn-icon-text btn-print-barcode">
...
<script type="text/javascript">
   $(document).ready(function() {
    ...
    function load_datatable(){
        $('#id-data_table').DataTable({
            ...
            ajax: {
                url : "{{ route('report.get_report_asset') }}",
                type: 'GET',
                data: function (f) {
   ...
   //Print button
    $(".btn-print-report").on('click', function(){
        var url         = '{{route("report.print_asset_report")}}';
        var filters     = {
   ...
   $('.btn-print-barcode').on('click', function (){
        ...
        var url = "{{ route('report.print_asset_barcodes') }}" + "/?" + $.param(query)
        window.open(url);
   });
   ...
   $('.btn-excel-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/export_assets')}}?" + $.param(query)
   ...
   $('.btn-pdf-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/generate_pdf_assets')}}?" + $.param(query)

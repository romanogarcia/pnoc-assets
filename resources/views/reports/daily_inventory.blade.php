...
@section('title', 'Daily Inventory Report - PNOC')
@section('customcss')
   ...
   <div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-lg-12 stretch-card">
            <div class="card">
               <div class="card-header">Daily Inventory Report</div>
                    ...
                    <div id="search-form_container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="date_range_pick" id="date_range_pick" placeholder="From - To" readonly="true" value="{{ date('m/d/Y - m/d/Y') }}">
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
   $(document).ready(function() {
    ...
    function load_datatable(){
        $('#id-data_table').DataTable({
            ...
            ajax: {
                url : "{{ route('report.get_daily_inventory') }}",
                type: 'GET',
                data: function (f) {
            ...
            columns: [
                ...
                { data: 'current_location', sortable:true },
                { data: 'original_location', sortable:true },
   ...
   $(".btn-print-report").on('click', function(){
        var url         = '{{route("report.print_daily_inventory_report")}}';
        var filters     = {
    ...
    $('.btn-excel-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/export_daily_inventory')}}?" + $.param(query)
    ...
    $('.btn-pdf-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/generate_pdf_daily_inventory')}}?" + $.param(query)

...
@section('title', 'Inventory List Report - PNOC')
@section('customcss')
   ...
   <div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-lg-12 stretch-card">
            <div class="card">
               <div class="card-header">Inventory List Report</div>
...
<script type="text/javascript">
   $(document).ready(function() {
    ...
    function load_datatable(){
        $('#id-data_table').DataTable({
            ...
            ajax: {
                url : "{{ route('report.get_inventory_list') }}",
                type: 'GET',
                data: function (f) {
   ...
   $(".btn-print-report").on('click', function(){
        var url         = '{{route("report.print_inventory_list_report")}}';
        var filters     = {
   ...
   $('.btn-excel-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/export_inventory_list')}}?" + $.param(query)
    ...
    $('.btn-pdf-download').on('click',function(){
	    ...
	    var url = "{{URL::to('report/generate_pdf_inventory_list')}}?" + $.param(query)
